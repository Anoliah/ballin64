...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_GOLD_RING, -11362, -2822, -14307, 0, 28, 0, (13 << 16), bhvGoldRing),
		OBJECT(MODEL_RED_RING, 7768, 3985, 7037, 0, 169, 0, (80 << 16), bhvRedRing),
		OBJECT(MODEL_NONE, 5238, 9375, -2586, 0, 171, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 171, 5238, 9375, -2586),
		TERRAIN(bitdw_area_1_collision),
		MACRO_OBJECTS(bitdw_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_TOGETHER),
