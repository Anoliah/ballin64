...
const LevelScript level_intro_splash_screen[] = {
    ...
    AREA(/*index*/ 1, intro_geo_splash_screen),
        OBJECT(/*model*/ MODEL_BALLIN, /*pos*/ -610, -440, 1500, /*angle*/ 0,  50, 0, /*behParam*/ BP(0x00, 0x01, 0x00, 0x00), /*beh*/ bhvBallinStartup),
        OBJECT(/*model*/ MODEL_BALLIN, /*pos*/  610, -440, 1500, /*angle*/ 0, -50, 0, /*behParam*/ BP(0x00, 0x00, 0x00, 0x00), /*beh*/ bhvBallinStartup),
    END_AREA(),
    FREE_LEVEL_POOL(),
