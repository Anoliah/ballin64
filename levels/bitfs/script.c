...
const LevelScript level_bitfs_entry[] = {
	...
	LOAD_YAY0(0x0A, _kart_skybox_yay0SegmentRomStart, _kart_skybox_yay0SegmentRomEnd), 
	...
	AREA(1, bitfs_area_1),
		...
		WARP_NODE(0xF0, LEVEL_BITFS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BITFS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_GOLD_RING, -10440, 3449, 6191, 0, 69, 0, (18 << 16), bhvGoldRing),
		OBJECT(MODEL_NONE, 9221, -2497, 10184, 0, -170, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, -170, 9221, -2497, 10184),
		TERRAIN(bitfs_area_1_collision),
		MACRO_OBJECTS(bitfs_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_MARIO_KART),
