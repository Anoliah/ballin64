...
SECRET_STAR(COURSE_BITDW, _("   THE BIG BOUNCE"))
SECRET_STAR(COURSE_BITFS, _("   MARIO KART"))
SECRET_STAR(COURSE_BITS, _("   ICY ROADS AHEAD"))
SECRET_STAR(COURSE_PSS, _("   RETRO"))
SECRET_STAR(COURSE_COTMC, _("   CAVERN OF THE METAL CAP"))
SECRET_STAR(COURSE_TOTWC, _("   TOWER OF THE WING CAP"))
SECRET_STAR(COURSE_VCUTM, _("   PINBALL"))
SECRET_STAR(COURSE_WMOTR, _("   TUTORIAL"))
SECRET_STAR(COURSE_SA, _("   FIREBALL"))
