...
#define SOUND_MARIO_OKEY_DOKEY                   /* 0x20210001 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x21, 0x00, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unused
...
#define SOUND_MOVING_BALLIN_ROLL                 /* 0x14000001 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x38, 0x00, SOUND_NO_PRIORITY_LOSS)
#define SOUND_MOVING_BALLIN_SLIP                 /* 0x14000001 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x39, 0x40, SOUND_NO_PRIORITY_LOSS)
#define SOUND_ACTION_BALLIN_BOUNCE               /* 0x04088081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x70, 0x00, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_BALLIN_DASH                 /* 0x04088081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x71, 0x40, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_BALLIN_BUMP                 /* 0x04088081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x72, 0x40, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#endif // SOUNDS_H
